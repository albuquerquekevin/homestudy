 CREATE PROCEDURE SP_P_AGENDAS_INSERT_MULTIPLO (
	...
	PSTA_IDE_ARRAY IN VARRAY(50) OF INT,
  ...
  BEGIN
	...
	FOR v_contador IN 1..PSTA_IDE_ARRAY.COUNT LOOP
		--VERIFICA SE A NOVA DATA GERADA PELO SUBTIPO É VÁLIDA
		IF PFLG_AUT = 1 THEN
			VAGE_DTA_PRE := F_AGENDA_AUTOMATICA(PAGE_DTA, PSTA_IDE);
		...
		,      0
		,      VCRE_IDE
		,      1, USER, SYSDATE, USER, SYSDATE, PSTA_IDE);
